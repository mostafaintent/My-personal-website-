...
export default async function CategorySidebar({ query }: { query?: string }) {
  ...
  return (
    <aside className="flex flex-col gap-8 text-sm">
      ...
      {categoryCounts.size > 0 && (
        <div>
          <p className="font-display mb-3 font-semibold">دسته‌ها</p>
      ...
      {yearCounts.size > 0 && (
        <div>
          <p className="font-display mb-3 font-semibold">بایگانی</p>
          <ul className="flex flex-col gap-2">
